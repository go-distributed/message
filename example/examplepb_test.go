...
func TestPreAcceptStringer(t *testing4.T) {
	popr := math_rand4.New(math_rand4.NewSource(time4.Now().UnixNano()))
	p := NewPopulatedPreAccept(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
...
func TestPreAcceptReplyStringer(t *testing4.T) {
	popr := math_rand4.New(math_rand4.NewSource(time4.Now().UnixNano()))
	p := NewPopulatedPreAcceptReply(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
...
func TestPreAcceptSize(t *testing5.T) {
	popr := math_rand5.New(math_rand5.NewSource(time5.Now().UnixNano()))
	p := NewPopulatedPreAccept(popr, true)
	size2 := code_google_com_p_gogoprotobuf_proto2.Size(p)
	data, err := code_google_com_p_gogoprotobuf_proto2.Marshal(p)
...
func BenchmarkPreAcceptSize(b *testing5.B) {
	popr := math_rand5.New(math_rand5.NewSource(time5.Now().UnixNano()))
	total := 0
	b.ResetTimer()
	b.StopTimer()
...
func TestPreAcceptReplySize(t *testing5.T) {
	popr := math_rand5.New(math_rand5.NewSource(time5.Now().UnixNano()))
	p := NewPopulatedPreAcceptReply(popr, true)
	size2 := code_google_com_p_gogoprotobuf_proto2.Size(p)
	data, err := code_google_com_p_gogoprotobuf_proto2.Marshal(p)
...
func BenchmarkPreAcceptReplySize(b *testing5.B) {
	popr := math_rand5.New(math_rand5.NewSource(time5.Now().UnixNano()))
	total := 0
	b.ResetTimer()
	b.StopTimer()
...
func TestPreAcceptGoString(t *testing6.T) {
	popr := math_rand6.New(math_rand6.NewSource(time6.Now().UnixNano()))
	p := NewPopulatedPreAccept(popr, false)
	s1 := p.GoString()
	s2 := fmt1.Sprintf("%#v", p)
...
func TestPreAcceptReplyGoString(t *testing6.T) {
	popr := math_rand6.New(math_rand6.NewSource(time6.Now().UnixNano()))
	p := NewPopulatedPreAcceptReply(popr, false)
	s1 := p.GoString()
	s2 := fmt1.Sprintf("%#v", p)
...
func TestPreAcceptFace(t *testing7.T) {
	popr := math_rand7.New(math_rand7.NewSource(time7.Now().UnixNano()))
	p := NewPopulatedPreAccept(popr, true)
	msg := p.TestProto()
	if !p.Equal(msg) {
...
func TestPreAcceptVerboseEqual(t *testing8.T) {
	popr := math_rand8.New(math_rand8.NewSource(time8.Now().UnixNano()))
	p := NewPopulatedPreAccept(popr, false)
	data, err := code_google_com_p_gogoprotobuf_proto3.Marshal(p)
	if err != nil {
...
func TestPreAcceptReplyVerboseEqual(t *testing8.T) {
	popr := math_rand8.New(math_rand8.NewSource(time8.Now().UnixNano()))
	p := NewPopulatedPreAcceptReply(popr, false)
	data, err := code_google_com_p_gogoprotobuf_proto3.Marshal(p)
	if err != nil {
